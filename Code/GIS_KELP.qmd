...
leaflet() %\>% \# Add default OpenStreetMap map tiles addTiles(group = "Default") %\>%\
\# Add our points addCircleMarkers(data = pc, group = "Protea cynaroides", radius = 3, color = "green")
